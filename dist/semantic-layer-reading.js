...
const layerContent = {
    ...
    4: `<h2>Layer 4: Cụm giới từ chỉ phạm vi</h2><div class="box"><h3>Ngữ pháp</h3><p><strong>from the development context, objectives, perspectives, and operational mechanisms to key tasks and strategic breakthroughs</strong></p><p>Đây là <strong>prepositional phrase</strong>: cụm giới từ theo cấu trúc <strong>from A to B</strong>.</p></div><div class="logic-flow"><span class="node">from A</span><span class="arrow">→</span><span class="node">development context / objectives / perspectives / mechanisms</span><span class="arrow">→</span><span class="node">to B</span><span class="arrow">→</span><span class="node">key tasks / strategic breakthroughs</span></div><p>Chức năng đọc hiểu: cụm này chỉ <strong>phạm vi bao quát</strong>, đi từ tầng nền tảng định hướng đến tầng nhiệm vụ và đột phá chiến lược.</p>`,
