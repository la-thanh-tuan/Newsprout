...
const layerContent = {
    ...
    4: `<h2>Layer 4: Quan hệ cấu trúc</h2><div class="box"><h3>Subtype phát hiện trong câu này</h3><p><strong>Prepositional phrase / Cụm giới từ chỉ phạm vi</strong></p><p>Cấu trúc cụ thể: <strong>from A to B</strong>.</p></div><div class="logic-flow"><span class="node">from A</span><span class="arrow">→</span><span class="node">development context / objectives / perspectives / mechanisms</span><span class="arrow">→</span><span class="node">to B</span><span class="arrow">→</span><span class="node">key tasks / strategic breakthroughs</span></div><p>Chức năng đọc hiểu: cụm này chỉ <strong>phạm vi bao quát</strong>, đi từ tầng nền tảng định hướng đến tầng nhiệm vụ và đột phá chiến lược.</p><div class="box"><h3>Gợi ý tổng quát</h3><p>Ở câu khác, Layer 4 có thể là mệnh đề quan hệ, mệnh đề phụ, cụm phân từ, so sánh, điều kiện hoặc quan hệ nguyên nhân - kết quả.</p></div>`,
